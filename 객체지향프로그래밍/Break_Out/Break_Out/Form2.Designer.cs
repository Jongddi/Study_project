...
namespace Break_Out
{
	partial class Form2
	{
		...
		private void InitializeComponent()
		{
			...
			this.label2.Text = "시작할 화면을 선택하세요";
			// 
			// button1
			// 
			...
			this.label3.Location = new System.Drawing.Point(264, 96);
			this.label3.Name = "label3";
			this.label3.Size = new System.Drawing.Size(95, 15);
			this.label3.TabIndex = 4;
			this.label3.Text = "Made BY 안종현";
			// 
			// Form2
			// 
